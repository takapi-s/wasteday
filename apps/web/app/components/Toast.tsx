...
const ToastItem: React.FC<ToastItemProps> = ({ toast }) => {
  ...
  const getToastStyles = () => {
    const baseStyles = "flex items-center p-4 mb-4 text-sm rounded-lg shadow-lg transition-all duration-300 ease-in-out transform translate-x-0 opacity-100";
  ...
  return (
    <div className={getToastStyles()}>
      ...
      <button
        type="button"
        className="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300"
